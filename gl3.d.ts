...
export module GL3 {
    ...
    function texParameterfv(target: number, pname: number, params: GLPointerType): void;
    function texParameteri(target: number, pname: number, param: number): void;
    function texParameteriv(target: number, pname: number, params: GLPointerType): void;
    function texImage1D(target: number, level: number, internalformat: number, width: number, border: number, format: number, type: number, pixels: GLPointerType): void;
    function texImage2D(target: number, level: number, internalformat: number, width: number, height: number, border: number, format: number, type: number, pixels: GLPointerType): void;
    ...
    function readPixels(x: number, y: number, width: number, height: number, format: number, type: number, pixels: GLPointerType): void;
    function getBooleanv(pname: number, params: GLPointerType): void;
    function getDoublev(pname: number, params: GLPointerType): void;
    function getError(): number;
    function getFloatv(pname: number, params: GLPointerType): void;
    function getIntegerv(pname: number, params: GLPointerType): void;
    function getString(name: number): string;
    function getTexImage(target: number, level: number, format: number, type: number, pixels: GLPointerType): void;
    function getTexParameterfv(target: number, pname: number, params: GLPointerType): void;
    function getTexParameteriv(target: number, pname: number, params: GLPointerType): void;
    function getTexLevelParameterfv(target: number, level: number, pname: number, params: GLPointerType): void;
    function getTexLevelParameteriv(target: number, level: number, pname: number, params: GLPointerType): void;
    ...
    function drawElements(mode: number, count: number, type: number, indices: GLPointerType): void;
    ...
    function texSubImage1D(target: number, level: number, xoffset: number, width: number, format: number, type: number, pixels: GLPointerType): void;
    function texSubImage2D(target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, type: number, pixels: GLPointerType): void;
    function bindTexture(target: number, texture: Texture | number): void;
    function genTextures(n: number, textures: number[]): void;
    function isTexture(texture: Texture | number): number;
    function blendColor(red: number, green: number, blue: number, alpha: number): void;
    function blendEquation(mode: number): void;
    function drawRangeElements(mode: number, start: number, end: number, count: number, type: number, indices: GLPointerType): void;
    function texImage3D(target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, format: number, type: number, pixels: GLPointerType): void;
    function texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, type: number, pixels: GLPointerType): void;
    ...
    function compressedTexImage3D(target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, imageSize: number, data: GLPointerType): void;
    function compressedTexImage2D(target: number, level: number, internalformat: number, width: number, height: number, border: number, imageSize: number, data: GLPointerType): void;
    function compressedTexImage1D(target: number, level: number, internalformat: number, width: number, border: number, imageSize: number, data: GLPointerType): void;
    function compressedTexSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, imageSize: number, data: GLPointerType): void;
    function compressedTexSubImage2D(target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, imageSize: number, data: GLPointerType): void;
    function compressedTexSubImage1D(target: number, level: number, xoffset: number, width: number, format: number, imageSize: number, data: GLPointerType): void;
    function getCompressedTexImage(target: number, level: number, img: GLPointerType): void;
    function blendFuncSeparate(sfactorRGB: number, dfactorRGB: number, sfactorAlpha: number, dfactorAlpha: number): void;
    function multiDrawArrays(mode: number, first: GLPointerType, count: GLPointerType, drawcount: number): void;
    function pointParameterf(pname: number, param: number): void;
    function pointParameterfv(pname: number, params: GLPointerType): void;
    function pointParameteri(pname: number, param: number): void;
    function pointParameteriv(pname: number, params: GLPointerType): void;
    function genQueries(n: number, ids: number[]): void;
    function isQuery(id: Query | number): number;
    function beginQuery(target: number, id: Query | number): void;
    function endQuery(target: number): void;
    function getQueryiv(target: number, pname: number, params: GLPointerType): void;
    function getQueryObjectiv(id: Query | number, pname: number, params: GLPointerType): void;
    function getQueryObjectuiv(id: Query | number, pname: number, params: GLPointerType): void;
    function bindBuffer(target: number, buffer: Buffer | number): void;
    function genBuffers(n: number, buffers: number[]): void;
    function isBuffer(buffer: Buffer | number): number;
    function bufferData(target: number, size: number, data: GLPointerType, usage: number): void;
    function bufferSubData(target: number, offset: number, size: number, data: GLPointerType): void;
    function getBufferSubData(target: number, offset: number, size: number, data: GLPointerType): void;
    function mapBuffer(target: number, access: number): GLPointerType;
    function unmapBuffer(target: number): number;
    function getBufferParameteriv(target: number, pname: number, params: GLPointerType): void;
    function blendEquationSeparate(modeRGB: number, modeAlpha: number): void;
    function drawBuffers(n: number, bufs: GLPointerType): void;
    ...
    function getActiveAttrib(program: Program | number, index: number, bufSize: number, length: GLPointerType, size: GLPointerType, type: GLPointerType, name: GLPointerType): void;
    function getActiveUniform(program: Program | number, index: number, bufSize: number, length: GLPointerType, size: GLPointerType, type: GLPointerType, name: GLPointerType): void;
    function getAttachedShaders(program: Program | number, maxCount: number, count: GLPointerType, shaders: number[]): void;
    function getAttribLocation(program: Program | number, name: string): number;
    function getProgramiv(program: Program | number, pname: number, params: GLPointerType): void;
    function getProgramInfoLog(program: Program | number, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
    function getShaderiv(shader: Shader | number, pname: number, params: GLPointerType): void;
    function getShaderInfoLog(shader: Shader | number, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
    function getShaderSource(shader: Shader | number, bufSize: number, length: GLPointerType, source: GLPointerType): void;
    function getUniformLocation(program: Program | number, name: string): number;
    function getUniformfv(program: Program | number, location: number, params: GLPointerType): void;
    function getUniformiv(program: Program | number, location: number, params: GLPointerType): void;
    function getVertexAttribdv(index: number, pname: number, params: GLPointerType): void;
    function getVertexAttribfv(index: number, pname: number, params: GLPointerType): void;
    function getVertexAttribiv(index: number, pname: number, params: GLPointerType): void;
    function isProgram(program: Program | number): number;
    function isShader(shader: Shader | number): number;
    function linkProgram(program: Program | number): void;
    function useProgram(program: Program | number): void;
    ...
    function uniform1fv(location: number, count: number, value: GLPointerType): void;
    function uniform2fv(location: number, count: number, value: GLPointerType): void;
    function uniform3fv(location: number, count: number, value: GLPointerType): void;
    function uniform4fv(location: number, count: number, value: GLPointerType): void;
    function uniform1iv(location: number, count: number, value: GLPointerType): void;
    function uniform2iv(location: number, count: number, value: GLPointerType): void;
    function uniform3iv(location: number, count: number, value: GLPointerType): void;
    function uniform4iv(location: number, count: number, value: GLPointerType): void;
    function uniformMatrix2fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function validateProgram(program: Program | number): void;
    function vertexAttrib1d(index: number, x: number): void;
    function vertexAttrib1dv(index: number, v: GLPointerType): void;
    function vertexAttrib1f(index: number, x: number): void;
    function vertexAttrib1fv(index: number, v: GLPointerType): void;
    function vertexAttrib1s(index: number, x: number): void;
    function vertexAttrib1sv(index: number, v: GLPointerType): void;
    function vertexAttrib2d(index: number, x: number, y: number): void;
    function vertexAttrib2dv(index: number, v: GLPointerType): void;
    function vertexAttrib2f(index: number, x: number, y: number): void;
    function vertexAttrib2fv(index: number, v: GLPointerType): void;
    function vertexAttrib2s(index: number, x: number, y: number): void;
    function vertexAttrib2sv(index: number, v: GLPointerType): void;
    function vertexAttrib3d(index: number, x: number, y: number, z: number): void;
    function vertexAttrib3dv(index: number, v: GLPointerType): void;
    function vertexAttrib3f(index: number, x: number, y: number, z: number): void;
    function vertexAttrib3fv(index: number, v: GLPointerType): void;
    function vertexAttrib3s(index: number, x: number, y: number, z: number): void;
    function vertexAttrib3sv(index: number, v: GLPointerType): void;
    function vertexAttrib4Nbv(index: number, v: GLPointerType): void;
    function vertexAttrib4Niv(index: number, v: GLPointerType): void;
    function vertexAttrib4Nsv(index: number, v: GLPointerType): void;
    function vertexAttrib4Nub(index: number, x: number, y: number, z: number, w: number): void;
    function vertexAttrib4Nubv(index: number, v: GLPointerType): void;
    function vertexAttrib4Nuiv(index: number, v: GLPointerType): void;
    function vertexAttrib4Nusv(index: number, v: GLPointerType): void;
    function vertexAttrib4bv(index: number, v: GLPointerType): void;
    function vertexAttrib4d(index: number, x: number, y: number, z: number, w: number): void;
    function vertexAttrib4dv(index: number, v: GLPointerType): void;
    function vertexAttrib4f(index: number, x: number, y: number, z: number, w: number): void;
    function vertexAttrib4fv(index: number, v: GLPointerType): void;
    function vertexAttrib4iv(index: number, v: GLPointerType): void;
    function vertexAttrib4s(index: number, x: number, y: number, z: number, w: number): void;
    function vertexAttrib4sv(index: number, v: GLPointerType): void;
    function vertexAttrib4ubv(index: number, v: GLPointerType): void;
    function vertexAttrib4uiv(index: number, v: GLPointerType): void;
    function vertexAttrib4usv(index: number, v: GLPointerType): void;
    function vertexAttribPointer(index: number, size: number, type: number, normalized: number, stride: number, pointer: GLPointerType): void;
    function uniformMatrix2x3fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3x2fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix2x4fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4x2fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3x4fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4x3fv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function colorMaski(index: number, r: number, g: number, b: number, a: number): void;
    function getBooleani_v(target: number, index: number, data: GLPointerType): void;
    function getIntegeri_v(target: number, index: number, data: GLPointerType): void;
    ...
    function getTransformFeedbackVarying(W_Program: number, index: number, bufSize: number, length: GLPointerType, size: GLPointerType, type: GLPointerType, name: GLPointerType): void;
    ...
    function vertexAttribIPointer(index: number, size: number, type: number, stride: number, pointer: GLPointerType): void;
    function getVertexAttribIiv(index: number, pname: number, params: GLPointerType): void;
    function getVertexAttribIuiv(index: number, pname: number, params: GLPointerType): void;
    ...
    function vertexAttribI1iv(index: number, v: GLPointerType): void;
    function vertexAttribI2iv(index: number, v: GLPointerType): void;
    function vertexAttribI3iv(index: number, v: GLPointerType): void;
    function vertexAttribI4iv(index: number, v: GLPointerType): void;
    function vertexAttribI1uiv(index: number, v: GLPointerType): void;
    function vertexAttribI2uiv(index: number, v: GLPointerType): void;
    function vertexAttribI3uiv(index: number, v: GLPointerType): void;
    function vertexAttribI4uiv(index: number, v: GLPointerType): void;
    function vertexAttribI4bv(index: number, v: GLPointerType): void;
    function vertexAttribI4sv(index: number, v: GLPointerType): void;
    function vertexAttribI4ubv(index: number, v: GLPointerType): void;
    function vertexAttribI4usv(index: number, v: GLPointerType): void;
    function getUniformuiv(program: Program | number, location: number, params: GLPointerType): void;
    function bindFragDataLocation(program: Program | number, color: number, name: string): void;
    function getFragDataLocation(program: Program | number, name: string): number;
    ...
    function uniform1uiv(location: number, count: number, value: GLPointerType): void;
    function uniform2uiv(location: number, count: number, value: GLPointerType): void;
    function uniform3uiv(location: number, count: number, value: GLPointerType): void;
    function uniform4uiv(location: number, count: number, value: GLPointerType): void;
    function texParameterIiv(target: number, pname: number, params: GLPointerType): void;
    function texParameterIuiv(target: number, pname: number, params: GLPointerType): void;
    function getTexParameterIiv(target: number, pname: number, params: GLPointerType): void;
    function getTexParameterIuiv(target: number, pname: number, params: GLPointerType): void;
    function clearBufferiv(buffer: number, drawbuffer: number, value: GLPointerType): void;
    function clearBufferuiv(buffer: number, drawbuffer: number, value: GLPointerType): void;
    function clearBufferfv(buffer: number, drawbuffer: number, value: GLPointerType): void;
    ...
    function drawElementsInstanced(mode: number, count: number, type: number, indices: GLPointerType, instancecount: number): void;
    function texBuffer(target: number, internalformat: number, buffer: Buffer | number): void;
    function primitiveRestartIndex(index: number): void;
    function getInteger64i_v(target: number, index: number, data: GLPointerType): void;
    function getBufferParameteri64v(target: number, pname: number, params: GLPointerType): void;
    function framebufferTexture(target: number, attachment: number, texture: Texture | number, level: number): void;
    ...
    function isRenderbuffer(renderbuffer: Renderbuffer | number): number;
    function bindRenderbuffer(target: number, renderbuffer: Renderbuffer | number): void;
    ...
    function getRenderbufferParameteriv(target: number, pname: number, params: GLPointerType): void;
    function isFramebuffer(framebuffer: Framebuffer | number): number;
    function bindFramebuffer(target: number, framebuffer: Framebuffer | number): void;
    function genFramebuffers(n: number, framebuffers: number[]): void;
    function checkFramebufferStatus(target: number): number;
    function framebufferTexture1D(target: number, attachment: number, textarget: number, texture: Texture | number, level: number): void;
    function framebufferTexture2D(target: number, attachment: number, textarget: number, texture: Texture | number, level: number): void;
    function framebufferTexture3D(target: number, attachment: number, textarget: number, texture: Texture | number, level: number, zoffset: number): void;
    function framebufferRenderbuffer(target: number, attachment: number, renderbuffertarget: number, renderbuffer: Renderbuffer | number): void;
    function getFramebufferAttachmentParameteriv(target: number, attachment: number, pname: number, params: GLPointerType): void;
    ...
    function framebufferTextureLayer(target: number, attachment: number, texture: Texture | number, level: number, layer: number): void;
    function mapBufferRange(target: number, offset: number, length: number, access: number): GLPointerType;
    function flushMappedBufferRange(target: number, offset: number, length: number): void;
    function bindVertexArray(array: VertexArray | number): void;
    function genVertexArrays(n: number, arrays: number[]): void;
    function isVertexArray(array: VertexArray | number): number;
    function getActiveUniformsiv(program: Program | number, uniformCount: number, uniformIndices: GLPointerType, pname: number, params: GLPointerType): void;
    function getActiveUniformName(program: Program | number, uniformIndex: number, bufSize: number, length: GLPointerType, uniformName: GLPointerType): void;
    function getUniformBlockIndex(program: Program | number, uniformBlockName: GLPointerType): number;
    function getActiveUniformBlockiv(program: Program | number, uniformBlockIndex: number, pname: number, params: GLPointerType): void;
    function getActiveUniformBlockName(program: Program | number, uniformBlockIndex: number, bufSize: number, length: GLPointerType, uniformBlockName: GLPointerType): void;
    function uniformBlockBinding(program: Program | number, uniformBlockIndex: number, uniformBlockBinding: number): void;
    function copyBufferSubData(readTarget: number, writeTarget: number, readOffset: number, writeOffset: number, size: number): void;
    function drawElementsBaseVertex(mode: number, count: number, type: number, indices: GLPointerType, basevertex: number): void;
    function drawRangeElementsBaseVertex(mode: number, start: number, end: number, count: number, type: number, indices: GLPointerType, basevertex: number): void;
    function drawElementsInstancedBaseVertex(mode: number, count: number, type: number, indices: GLPointerType, instancecount: number, basevertex: number): void;
    ...
    function getMultisamplefv(pname: number, index: number, val: GLPointerType): void;
    function sampleMaski(index: number, mask: number): void;
    function bindFragDataLocationIndexed(program: Program | number, colorNumber: number, index: number, name: GLPointerType): void;
    function getFragDataIndex(program: Program | number, name: GLPointerType): number;
    function genSamplers(count: number, samplers: number[]): void;
    function isSampler(sampler: Sampler | number): number;
    function bindSampler(unit: number, sampler: Sampler | number): void;
    function samplerParameteri(sampler: Sampler | number, pname: number, param: number): void;
    function samplerParameteriv(sampler: Sampler | number, pname: number, param: GLPointerType): void;
    function samplerParameterf(sampler: Sampler | number, pname: number, param: number): void;
    function samplerParameterfv(sampler: Sampler | number, pname: number, param: GLPointerType): void;
    function samplerParameterIiv(sampler: Sampler | number, pname: number, param: GLPointerType): void;
    function samplerParameterIuiv(sampler: Sampler | number, pname: number, param: GLPointerType): void;
    function getSamplerParameteriv(sampler: Sampler | number, pname: number, params: GLPointerType): void;
    function getSamplerParameterIiv(sampler: Sampler | number, pname: number, params: GLPointerType): void;
    function getSamplerParameterfv(sampler: Sampler | number, pname: number, params: GLPointerType): void;
    function getSamplerParameterIuiv(sampler: Sampler | number, pname: number, params: GLPointerType): void;
    function queryCounter(id: number, target: number): void;
    function getQueryObjecti64v(id: number, pname: number, params: GLPointerType): void;
    function getQueryObjectui64v(id: number, pname: number, params: GLPointerType): void;
    function vertexAttribP1ui(index: number, type: number, normalized: number, value: number): void;
    function vertexAttribP1uiv(index: number, type: number, normalized: number, value: GLPointerType): void;
    function vertexAttribP2ui(index: number, type: number, normalized: number, value: number): void;
    function vertexAttribP2uiv(index: number, type: number, normalized: number, value: GLPointerType): void;
    function vertexAttribP3ui(index: number, type: number, normalized: number, value: number): void;
    function vertexAttribP3uiv(index: number, type: number, normalized: number, value: GLPointerType): void;
    function vertexAttribP4ui(index: number, type: number, normalized: number, value: number): void;
    function vertexAttribP4uiv(index: number, type: number, normalized: number, value: GLPointerType): void;
    function drawArraysIndirect(mode: number, indirect: GLPointerType): void;
    function drawElementsIndirect(mode: number, type: number, indirect: GLPointerType): void;
    ...
    function uniform1dv(location: number, count: number, value: GLPointerType): void;
    function uniform2dv(location: number, count: number, value: GLPointerType): void;
    function uniform3dv(location: number, count: number, value: GLPointerType): void;
    function uniform4dv(location: number, count: number, value: GLPointerType): void;
    function uniformMatrix2dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix2x3dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix2x4dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3x2dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix3x4dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4x2dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function uniformMatrix4x3dv(location: number, count: number, transpose: number, value: GLPointerType): void;
    function getUniformdv(program: number, location: number, params: GLPointerType): void;
    function getSubroutineUniformLocation(program: Program | number, shadertype: number, name: GLPointerType): number;
    function getSubroutineIndex(program: Program | number, shadertype: number, name: GLPointerType): number;
    function getActiveSubroutineUniformiv(program: Program | number, shadertype: number, index: number, pname: number, values: GLPointerType): void;
    function getActiveSubroutineUniformName(program: Program | number, shadertype: number, index: number, bufsize: number, length: GLPointerType, name: GLPointerType): void;
    function getActiveSubroutineName(program: Program | number, shadertype: number, index: number, bufsize: number, length: GLPointerType, name: GLPointerType): void;
    function uniformSubroutinesuiv(shadertype: number, count: number, indices: GLPointerType): void;
    function getUniformSubroutineuiv(shadertype: number, location: number, params: GLPointerType): void;
    function getProgramStageiv(program: Program | number, shadertype: number, pname: number, values: GLPointerType): void;
    function patchParameteri(pname: number, value: number): void;
    function patchParameterfv(pname: number, values: GLPointerType): void;
    function bindTransformFeedback(target: number, id: TransformFeedback | number): void;
    function genTransformFeedbacks(n: number, ids: number[]): void;
    function isTransformFeedback(id: TransformFeedback | number): number;
    function pauseTransformFeedback(): void;
    function resumeTransformFeedback(): void;
    function drawTransformFeedback(mode: number, id: TransformFeedback | number): void;
    ...
    function getQueryIndexediv(target: number, index: number, pname: number, params: GLPointerType): void;
    function releaseShaderCompiler(): void;
    function shaderBinary(count: number, shaders: number[], binaryformat: number, binary: GLPointerType, length: number): void;
    function getShaderPrecisionFormat(shadertype: number, precisiontype: number, range: GLPointerType, precision: GLPointerType): void;
    function depthRangef(n: number, f: number): void;
    function clearDepthf(d: number): void;
    function getProgramBinary(program: Program | number, bufSize: number, length: GLPointerType, binaryFormat: GLPointerType, binary: GLPointerType): void;
    function programBinary(program: Program | number, binaryFormat: number, binary: GLPointerType, length: number): void;
    function programParameteri(program: Program | number, pname: number, value: number): void;
    function useProgramStages(pipeline: ProgramPipeline | number, stages: number, program: Program | number): void;
    function activeShaderProgram(pipeline: ProgramPipeline | number, program: Program | number): void;
    function bindProgramPipeline(pipeline: ProgramPipeline | number): void;
    function genProgramPipelines(n: number, pipelines: number[]): void;
    function isProgramPipeline(pipeline: ProgramPipeline | number): number;
    function getProgramPipelineiv(pipeline: ProgramPipeline | number, pname: number, params: GLPointerType): void;
    function programUniform1i(program: Program | number, location: number, v0: number): void;
    function programUniform1iv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform1f(program: Program | number, location: number, v0: number): void;
    function programUniform1fv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform1d(program: Program | number, location: number, v0: number): void;
    function programUniform1dv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform1ui(program: Program | number, location: number, v0: number): void;
    function programUniform1uiv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform2i(program: Program | number, location: number, v0: number, v1: number): void;
    function programUniform2iv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform2f(program: Program | number, location: number, v0: number, v1: number): void;
    function programUniform2fv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform2d(program: Program | number, location: number, v0: number, v1: number): void;
    function programUniform2dv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform2ui(program: Program | number, location: number, v0: number, v1: number): void;
    function programUniform2uiv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform3i(program: Program | number, location: number, v0: number, v1: number, v2: number): void;
    function programUniform3iv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform3f(program: Program | number, location: number, v0: number, v1: number, v2: number): void;
    function programUniform3fv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform3d(program: Program | number, location: number, v0: number, v1: number, v2: number): void;
    function programUniform3dv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform3ui(program: Program | number, location: number, v0: number, v1: number, v2: number): void;
    function programUniform3uiv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform4i(program: Program | number, location: number, v0: number, v1: number, v2: number, v3: number): void;
    function programUniform4iv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform4f(program: Program | number, location: number, v0: number, v1: number, v2: number, v3: number): void;
    function programUniform4fv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform4d(program: Program | number, location: number, v0: number, v1: number, v2: number, v3: number): void;
    function programUniform4dv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniform4ui(program: Program | number, location: number, v0: number, v1: number, v2: number, v3: number): void;
    function programUniform4uiv(program: Program | number, location: number, count: number, value: GLPointerType): void;
    function programUniformMatrix2fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix2dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix2x3fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3x2fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix2x4fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4x2fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3x4fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4x3fv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix2x3dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3x2dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix2x4dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4x2dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix3x4dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function programUniformMatrix4x3dv(program: Program | number, location: number, count: number, transpose: number, value: GLPointerType): void;
    function validateProgramPipeline(pipeline: ProgramPipeline | number): void;
    function getProgramPipelineInfoLog(pipeline: ProgramPipeline | number, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
    ...
    function vertexAttribL1dv(index: number, v: GLPointerType): void;
    function vertexAttribL2dv(index: number, v: GLPointerType): void;
    function vertexAttribL3dv(index: number, v: GLPointerType): void;
    function vertexAttribL4dv(index: number, v: GLPointerType): void;
    function vertexAttribLPointer(index: number, size: number, type: number, stride: number, pointer: GLPointerType): void;
    function getVertexAttribLdv(index: number, pname: number, params: GLPointerType): void;
    function viewportArrayv(first: number, count: number, v: GLPointerType): void;
    function viewportIndexedf(index: number, x: number, y: number, w: number, h: number): void;
    function viewportIndexedfv(index: number, v: GLPointerType): void;
    function scissorArrayv(first: number, count: number, v: GLPointerType): void;
    function scissorIndexed(index: number, left: number, bottom: number, width: number, height: number): void;
    function scissorIndexedv(index: number, v: GLPointerType): void;
    function depthRangeArrayv(first: number, count: number, v: GLPointerType): void;
    function depthRangeIndexed(index: number, n: number, f: number): void;
    function getFloati_v(target: number, index: number, data: GLPointerType): void;
    function getDoublei_v(target: number, index: number, data: GLPointerType): void;
}