...
export module GL3 {
    ...
    function getQueryObjectiv(id: Query, pname: number, params: GLPointerType): void;
    function getQueryObjectuiv(id: Query, pname: number, params: GLPointerType): void;
    ...
    function getActiveAttrib(program: Program, index: number, bufSize: number, length: GLPointerType, size: GLPointerType, type: GLPointerType, name: GLPointerType): void;
    function getActiveUniform(program: Program, index: number, bufSize: number, length: GLPointerType, size: GLPointerType, type: GLPointerType, name: GLPointerType): void;
    function getAttachedShaders(program: Program, maxCount: number, count: GLPointerType, shaders: number[]): void;
    function getAttribLocation(program: Program, name: string): number;
    function getProgramiv(program: Program, pname: number, params: GLPointerType): void;
    function getProgramInfoLog(program: Program, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
    function getShaderiv(shader: Shader, pname: number, params: GLPointerType): void;
    function getShaderInfoLog(shader: Shader, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
    function getShaderSource(shader: Shader, bufSize: number, length: GLPointerType, source: GLPointerType): void;
    function getUniformLocation(program: Program, name: string): number;
    function getUniformfv(program: Program, location: number, params: GLPointerType): void;
    function getUniformiv(program: Program, location: number, params: GLPointerType): void;
    ...
    function getUniformuiv(program: Program, location: number, params: GLPointerType): void;
    ...
    function getActiveUniformsiv(program: Program, uniformCount: number, uniformIndices: Buffer | string | number | number[], pname: number, params: GLPointerType): void;
    function getActiveUniformName(program: Program, uniformIndex: number, bufSize: number, length: GLPointerType, uniformName: GLPointerType): void;
    function getUniformBlockIndex(program: Program, uniformBlockName: Buffer | string | number | number[]): number;
    function getActiveUniformBlockiv(program: Program, uniformBlockIndex: number, pname: number, params: GLPointerType): void;
    function getActiveUniformBlockName(program: Program, uniformBlockIndex: number, bufSize: number, length: GLPointerType, uniformBlockName: GLPointerType): void;
    ...
    function getSamplerParameteriv(sampler: Sampler, pname: number, params: GLPointerType): void;
    function getSamplerParameterIiv(sampler: Sampler, pname: number, params: GLPointerType): void;
    function getSamplerParameterfv(sampler: Sampler, pname: number, params: GLPointerType): void;
    function getSamplerParameterIuiv(sampler: Sampler, pname: number, params: GLPointerType): void;
    ...
    function getActiveSubroutineUniformiv(program: Program, shadertype: number, index: number, pname: number, values: GLPointerType): void;
    function getActiveSubroutineUniformName(program: Program, shadertype: number, index: number, bufsize: number, length: GLPointerType, name: GLPointerType): void;
    function getActiveSubroutineName(program: Program, shadertype: number, index: number, bufsize: number, length: GLPointerType, name: GLPointerType): void;
    ...
    function getProgramStageiv(program: Program, shadertype: number, pname: number, values: GLPointerType): void;
    ...
    function getProgramBinary(program: Program, bufSize: number, length: GLPointerType, binaryFormat: GLPointerType, binary: GLPointerType): void;
    ...
    function getProgramPipelineiv(pipeline: ProgramPipeline, pname: number, params: GLPointerType): void;
    ...
    function getProgramPipelineInfoLog(pipeline: ProgramPipeline, bufSize: number, length: GLPointerType, infoLog: GLPointerType): void;
